...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (urlError) {
      ...
      setError(errorMessages[urlError] ?? decodeURIComponent(urlError))
    }
  }, [searchParams])
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-white/50">登录您的账户</p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-lg p-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full px-3 py-2.5 pr-10 bg-white/5 border border-white/10 rounded text-white text-sm placeholder:text-white/30 focus:outline-none focus:border-white/30 transition-colors"
                />
                <button
                  type="button"
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 py-2.5 bg-white/5 border border-white/10 rounded text-white text-sm hover:bg-white/10 transition-colors flex items-center justify-center gap-2"
            >
